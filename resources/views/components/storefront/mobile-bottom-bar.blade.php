<div class="fixed bottom-0 inset-x-0 z-50 lg:hidden bg-safety text-white shadow-[0_-4px_12px_rgba(0,0,0,0.15)]">
    <a href="tel:+97677001122" class="flex items-center justify-center gap-3 py-3 px-4">
        ...
        <span class="font-oswald font-semibold text-base tracking-wide">7700-1122 ЗАЛГАХ</span>
    </a>
</div>
